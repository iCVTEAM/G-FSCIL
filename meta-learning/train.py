...
def get_command_line_parser():
    ...
    parser.add_argument('-epochs_new', type=int, default=0)
    ...
    parser.add_argument('-batch_size_new', type=int, default=100, help='set 0 will use all the availiable training image for new')
